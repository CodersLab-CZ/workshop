"""
Module for working with hashed passwords. Made by Coderslab.
"""

import hashlib
from random import choice
from string import ascii_letters, digits  # all alphanumeric characters, used for salt
...
def generate_salt():
    ...
    for i in range(0, 16):
        ...
        salt += choice(ascii_letters + digits)
    return salt
